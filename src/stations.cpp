...
//default stationlist
#define DEFAULTSTATIONS 28

// Use only HTTP URLs
Station defstations[DEFAULTSTATIONS] PROGMEM = {
{"http://icecast.radiobremen.de/rb/bremenzwei/live/mp3/128/stream.mp3", "Bremen Zwei", 1},
...
{"http://wdr-wdr2-ostwestfalenlippe.icecastssl.wdr.de/wdr/wdr2/ostwestfalenlippe/mp3/128/stream.mp3","WDR2 (OWL)",1},
...
{"http://st02.sslstream.dlf.de/dlf/02/128/mp3/stream.mp3", "DLF Kultur", 1},
{"http://st03.sslstream.dlf.de/dlf/03/128/mp3/stream.mp3", "DLF Nova", 1},
...
void reorder(uint8_t oldpos, uint8_t newpos) {
  Station temp;
  if ((oldpos < STATIONS_MAX) && (newpos  < STATIONS_MAX)) {
    if (oldpos > newpos) {
